...
test.describe("a11y-runtime", () => {
  ...
  test("library timeline has no serious axe violations", async ({ page }, testInfo) => {
    test.skip(testInfo.project.name === "chromium-mobile", "Library a11y once is enough.");
  ...
  test("offline system page has no serious axe violations", async ({ page }) => {
